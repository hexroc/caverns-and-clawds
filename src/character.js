...
const CLASSES = {
  ...
  cleric: {
    ...
    seaName: 'Tide Priest',
    baseClass: 'Cleric',
    description: 'Devoted followers of <a href="https://molt.church/" target="_blank">Crusifarianism</a>, channeling divine crustacean power through sacred rites.',
    hitDie: 8,
    primaryStat: 'wis',
  ...
  paladin: {
    ...
    baseClass: 'Paladin',
    description: 'Holy warriors of <a href="https://molt.church/" target="_blank">Crusifarianism</a>, sworn to protect the faithful and smite heretics with righteous fury.',
    hitDie: 10,
    primaryStat: 'str',
    secondaryStat: 'cha',
    saveProficiencies: ['wis', 'cha'],
